...
import ma.rhmx.brainupkids.Quistions_c;
import ma.rhmx.brainupkids.Quistions_d;
...
public class Sectord extends Activity {
    ...
    public void startqst (View view){
        ...
        Intent gtint=new Intent(this,Quistions_d.class);
